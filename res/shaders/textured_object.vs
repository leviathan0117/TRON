...
mat3 getRotationMatrix(float yaw_angle, float pitch_angle, float roll_angle)
{
...
void main()
{
    ...
    vec3 object_pos = mr * vec3(position.x * resize, position.y * resize, position.z * resize);
