...
class TronWindow:
    ...
    def create(self, **kwargs):
        ...
        glfw.set_cursor_pos_callback(self.opengl_id, context.main_context.cameras[self.camera_list[0]].mouse_callback)
    ...
    def draw(self):
        ...
        context.main_context.current_camera = self.camera_list[0]

        self.activate()

        self.user_function()

        cam = context.main_context.cameras[self.camera_list[0]]
    ...
    def window_resize(self, window, width, height):
        ...
        context.main_context.cameras[self.camera_list[0]].camera_projection_matrix = camera_projection_matrix
